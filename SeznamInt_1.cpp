...
void SeznamInt_1::realokace()
{
	...
	int* newHodnoty = new int[newCapacity];

	for (int i = 0; i < n; i++) {
		newHodnoty[i] = this->p_hodnoty[i];
	}

	delete[] p_hodnoty;
	p_hodnoty = newHodnoty;
...
// operator
istream& operator>>(istream& is, SeznamInt_1& o)
{
	cout << "inicializace cteni dat...\n";
	int temp;
